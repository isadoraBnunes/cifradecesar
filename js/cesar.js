...
document.getElementById("codificar").addEventListener('click', () => {
  ...
  for (var i = 0; i < textoCodificar.length; i++) {
    ...
    let posicionamentoDaLetra = textoCodificar.charCodeAt(i)-64; //posição da letra no alfabeto
    let deslocamentoDaLetra = (posicionamentoDaLetra + parseInt(chaveCodificar)) % 26; //deslocamento da letra para cifra de cesar e se mantem dentro das 26 letras
